...
import trnsport from '../../assets/02.jpg';
  ...
  return (
    <>
      ...
      <div>
          ...
          <Col md="4" sm="12">
            <div className="d-flex justify-content-center align-items-center">
              ...
              >
                ...
                <Card.Body>
                  <div className="d-flex justify-content-center">
                    <Button variant="primary">Transport Services IN {travelPlace.locationName}</Button>
                  </div>
                </Card.Body>
              </Card>
            </div>
        ...
        <br />
        <div className="d-flex justify-content-center">
          <Button style={{ color: 'black', padding: '10px' }} variant="warning">
            Plan Your Trip
          </Button>
        </div>
        <br /><br />
